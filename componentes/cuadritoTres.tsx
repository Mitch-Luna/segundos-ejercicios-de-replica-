...
export default function CuadritoTres() {
...
if (!fontsLoaded) return null;
    return (
        ...
        <View style={styles.cabecera}>
            ...
            <Ionicons style={styles.perfilApple} name="logo-apple" size={34} color="black" />
            </View>
        <View style={styles.contenedorletras}>
            <Text style={{ fontFamily: 'Ubuntu', fontSize: 21 }}> Business Analyst</Text>
            <Text style={{fontFamily: 'Oswald', fontSize: 15,color:'rgb(113, 107, 107)' }}>Apple Inc.</Text>
        </View>
        <View style={styles.figurita}>
            ...
            <View style={styles.cajitaAbajo}>
              <Text style={styles.lugar}>Chicago,   United States</Text>
              <Text style={styles.precios}>$5,000 - $12,000/month</Text>
              </View>
              <View style={styles.cajitabotenes}>
              <TouchableOpacity style={styles.botonuno}>
                    <Text style={styles.nombreBoton}>Freelance</Text>
                </TouchableOpacity>
